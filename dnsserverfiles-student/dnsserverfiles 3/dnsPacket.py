...
class DNSPacket: 
    ...
    def set_ID(self, ID):
        self.binaryString[0:17] = Util.intToBinary(ID, 16)
    ...
    def set_Opcode(self, opcode):
        self.binaryString[17:21] = Util.intToBinary(opcode, 4) 
    ...
    def set_Z(self, binaryStringZ):
        self.binaryString[25: 28] = binaryStringZ
    ...
    def set_RCODE(self, RCODE):
        self.binaryString[28: 32] = Util.intToBinary(RCODE, 4)
    ...
    def set_QDCOUNT(self, QDCOUNT):
        self.binaryString[32: 48] = Util.intToBinary(QDCOUNT, 16)
    ...
    def set_ANCOUNT(self, ANCOUNT): 
        self.binaryString[48: 64] = Util.intToBinary(ANCOUNT, 16)
    ...
    def set_NSCOUNT(self, NSCOUNT): 
        self.binaryString[64: 80] = Util.intToBinary(NSCOUNT, 16)
    ...
    def set_ARCOUNT(self, ARCOUNT): 
        self.binaryString[80: 96] = Util.intToBinary(ARCOUNT, 16)
